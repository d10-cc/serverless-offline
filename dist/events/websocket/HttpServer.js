...
class HttpServer {
  constructor(options, webSocketClients, v3Utils) {
    ...
    if (typeof httpsProtocol === 'string' && httpsProtocol.length > 0) {
      serverOptions.tls = {
        cert: (0, _nodeFs.readFileSync)((0, _nodePath.resolve)(httpsProtocol, 'cert.pem'), 'ascii'),
        key: (0, _nodeFs.readFileSync)((0, _nodePath.resolve)(httpsProtocol, 'key.pem'), 'ascii')
      };
    }
